...
import { BookingContext } from "@/app/ClientSide/room/page"
import { calculateBookingTotals } from "@/components/utils/pricing"
import { useSurchargePoliciesOnce } from "@/hooks/ClientSide/useSurchargePolicyStore";
...
export default function BookingSummary({ selectedPackages, onRemovePackage }: BookingSummaryProps) {
  ...
  const createBookingURL = () => {
    ...
    return `/ClientSide/bookingRoom?${params.toString()}`
  }
